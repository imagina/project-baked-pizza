<template>
  <div id="iblogShow"
    ...
    <!--= POST =-->
    <post-component v-if="!dataPost.children || !dataPost.children.length"
                    :category="dataPost">
    </post-component>
  </div>
</template>
<script>
  /*Component*/
  import postComponent from '@imagina/qblog/_components/postSlider'
