...
export default {
  ...
  changePasswordComplete: {
    ...
    name: 'auth.reset',
    layout: require('@imagina/quser/_layouts/resetComplete').default,
    containerLayout: blank,
    title: 'Change Password',
    icon: 'fas fa-chart-bar'
  },
  forgetPassword: {
    ...
    name: 'auth.change.forgetPassword',
    layout: require('@imagina/quser/_layouts/forgetPassword').default,
    containerLayout: blank,
    title: 'Change Password',
    icon: 'fas fa-chart-bar'
  },
